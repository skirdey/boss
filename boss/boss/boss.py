        ...
        try:
            ...
            for idx, estimate in enumerate(estimation.estimated_steps):
                step = {
                    ...
                    "additional_steps": estimation.additional_steps if estimation.additional_steps else [],
                    "critical_path_steps": estimation.critical_path_steps if estimation.critical_path_steps else [],
                    "overall_plan": estimation.overall_plan,
                    "state": TaskState.CREATED.value,
                    "targets": estimate.targets if estimate.targets else [],
